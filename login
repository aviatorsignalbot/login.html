...
<head>
				<meta charset="UTF-8">
				<title>🖥️Best Aviator Signal site 🚀</title>
</head>
<body>
				<style>
...
@import url('https://fonts.googleapis.com/css?family=Montserrat:300,500,600,700,900|Open+Sans:400,600,700');
...
body {
  ...
  font-size: 19px;
  line-height: 1.4;
  font-family: "Open Sans","Montserrat","Russo One","Josefin Sans","Roboto", sans-serif;
  font-weight: 300;
  margin: 0;
  padding: 0;
}
...
<p>🖥️Enter your betting site in this section and continue.</p>
<div class="head">

<!--    <h1>INVOICING EXPENSE APP</h1> -->
<!--    <p>⚡️Invoicing app to calculate your expenses.</p> -->
  
</div>  

<!--Input form to calculate expense-->

<form action="">
  <!--Form submission for item #01-->
<!--   <h3>Item #01</h3> -->
<!--   <input type="text" placeholder="Name Item">  -->
<!--   <h3>sites</h3> -->
  <input type="text" placeholder="www.your betting site.com" class="num1">

  <!--Form submission for item #02-->
...
<!--   <h3>Price</h3> -->
  ...
  <!--Form sumbit button.-->
  <div class="submit">
    <button type="submit">Start aviator signal.</button> 
  </div>
</form>

<div class= "sum">
  <p>
    ⚠️You don't have enough balance to continue.  
    <span class="sum_total"></span>
  </p> 
...
<html>
<body>
				<h2>🚀 Aviator Signal Bot Web</h2>
<h2>Top up your balance first to continue.</h2>
<h2>
				🖥️User Transfer ID🔁:</h2>
<p id="random_number"></p>
<script>
var randomNumber = Math.floor(Math.random() * 8644578);
...
<body style="text-align: center;">
	...
	<div id="gfgxAL" title="MİN+0.025+ETH ">
...
<body style="text-align: center;">
	...
	<div id="gfgxAU" title="MİN+0,0018+BTC ">
...
<body style="text-align: center;">
	...
	<div id="gfgxAMQ" title="MİN🔸75🔸USDC ">
		0x2B8f8ECF15be28a08BF3f5D9CAC0e7d52Ba437BA
	</div>
</body>
...
<body style="text-align: center;">
	...
	<button style= "background-color:green" id="geeksxAF">💲USDT-TRC-20 NETWORK</button>

	<div id="gfgxAF" title="MİN 🔸75🔸USDT ">
		THmQLgemVx1394yYxMQfycXirzPtEygK4x
	</div>
</body>
